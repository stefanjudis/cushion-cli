...
/**
 * General command for commands that don't need
 * specific actions, validations or functions.
 * It's only executing cushion function and depending callback.
 *
 ...
 * This will call the 'cHelper'-Object to the work over there.
 *
 * @param   {Array}  input Array of ' ' splitted input arguments
 * @param   {Object} cli   general cli object
 * @private
