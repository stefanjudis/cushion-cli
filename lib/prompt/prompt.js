...
cPrompt._promptCheckForUpdatesCallback = function(check) {
  if (check.match(/^[yY]*?(es)?$/)) {
    ...
    d.on('error', function(error) {
      console.log(
        clc.red('!!! Ohhh something went horribly wrong with the NPM connection!!!\n') +
        '\nWould be nice if you could create a bug ticket at\n' +
        clc.green('\nhttps://github.com/stefanjudis/cushion-cli/issues\n') +
